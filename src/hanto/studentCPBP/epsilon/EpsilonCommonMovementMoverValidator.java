 ...
 *
 */
public abstract class EpsilonCommonMovementMoverValidator implements IHantoMoverValidator 
{
	 ...
	 */
	public EpsilonCommonMovementMoverValidator(IHantoMover mover, EpsilonHantoRuleSet rules) 
	{
		this.mover = mover;
		this.rules = rules;
	}
	...
	public EpsilonHantoRuleSet getRules()
	{
		return rules;
	}
